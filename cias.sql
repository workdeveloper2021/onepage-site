...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2022 at 01:55 PM
...
CREATE TABLE `banner` (
  ...
  `active_status` int(6) NOT NULL DEFAULT 1,
  `delete_status` int(6) NOT NULL DEFAULT 1,
...
INSERT INTO `banner` (`id`, `heading`, `sub_heading`, `description`, `image`, `active_status`, `delete_status`, `created_at`, `updated_at`) VALUES
(2, 'sadsadsad', 'sadas', '<p>Limited time offer download and updated our app, synthesize accurate users whereas communities assertively evolve technically sound whereas real-time materials.</p>\r\n', 'assets/uploads/banner/1669121137.png', 1, 1, '0000-00-00 00:00:00.000000', '2022-11-22 12:45:37.813445');
